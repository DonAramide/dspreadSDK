...
public class ProfileParser {
    ...
    public static String BRAND = "ANL_HORIZONPAY";
    ...
    public static void parseNewProfile(String response) throws JSONException {
        ...
        karrabofeerule = in.getString("karrabofeerule");
        superagentfeerule = in.getString("superagentfeerule");
        ktransferrule = in.getString("ktransferrule");
        ...
        ptspemail = in.getString("ptspemail");
        ptspaddress = in.getString("ptspaddress");
        ptspnumber = in.getString("ptspnumber");
        ptspname = in.getString("ptspname");
        ...
        aggretransferfee = in.getString("aggretransferfee");
        aggrewithdrawalfee = in.getString("aggrewithdrawalfee");
        ...
        profilekarrabopay = in.getString("profilekarrabopay");
