...
public class GetCurrentGPSLocation extends AppCompatActivity implements LocationListener {
    ...
    public GetCurrentGPSLocation(Context context, Activity act) {
        ...
        try {
            ...
            if ( Build.VERSION.SDK_INT >= 23 &&
                ...
                ActivityCompat.requestPermissions(act, new
                        String[]{android.Manifest.permission.ACCESS_FINE_LOCATION, android.Manifest.permission.ACCESS_COARSE_LOCATION},22);
            }
    ...
    public boolean checkLocationServiceEnabled() {
        ...
        if (!gps_enabled && !network_enabled) {
            ...
            new AlertDialog.Builder(mContext)
                    .setCancelable(false)
                    .setMessage("GPRS not up, Like to open?")
