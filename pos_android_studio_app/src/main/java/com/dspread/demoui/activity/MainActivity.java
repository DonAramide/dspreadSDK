...
import com.dspread.demoui.activity.nibssImpl.Nibss_Home_Fragment;
...
public class MainActivity extends AppCompatActivity implements TitleUpdateListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    private Nibss_Home_Fragment  nibssHomeFragment;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_mifareCards:
                ...
                break;
            case R.id.nav_nibss:
                toolbar.setTitle(getString(R.string.menu_nibss));
                switchFragment(9);
                drawerLayout.close();
                break;
            case R.id.nav_exit:
...
//                        finish();
    ...
    public void switchFragment(int i) {
        ...
        switch (i) {
            ...
            case 9:
                if (nibssHomeFragment == null) {
                    nibssHomeFragment = new Nibss_Home_Fragment();
                    transaction.add(R.id.nav_host_fragment_content_main, nibssHomeFragment);
                }
                break;
