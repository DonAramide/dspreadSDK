...
import static com.dspread.demoui.utils.TLVParser.parse;
...
public class PaymentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       transactionCallbackCls = new TransactionCallbackCls();
        MyQposClass.setTransactionCallback(transactionCallbackCls);
...
//                        TRACE.i("nfc batchdata1: " + tlv);
                    ...
                    Log.d("==>", "content B==>  content" +  content.toString());
...
//            statusEditText.setText(getString(R.string.request_terminal_time) + " " + terminalTime);
        ...
        public void onDoTradeResult(QPOSService.DoTradeResult result, Hashtable<String, String> decodeData) {
            ...
            Log.d("==>", "content ==>  decodeData" +  decodeData.toString());
            Log.d("==>", "content ==>  onDoTradeResult"  );
...
//                statusEditText.setText(getString(R.string.card_inserted));
                        ...
                        if (formatID.equals("31") || formatID.equals("40") || formatID.equals("37") || formatID.equals("17") || formatID.equals("11") || formatID.equals("10")) {
                            ...
                            cardNo = maskedPAN;
                            Log.d("==>", "content ==>  MCR" +  content.toString());
...
//					content += getString(R.string.ksn) + " " + ksn + "\n";
                            ...
                            cardNo = maskedPAN;
                            String realPan = null;
                            Log.d("==>", "content ==>  NON-MCR" +  content.toString());

                        }
                            Log.d("==>", "content ==>  contsssssent" +  content.toString());
...
//                            gaTranResponseInfo.setCardScheme(emvTransResult.getAppname());
//                            gaTranResponseInfo.setMaskedPan(encrypPan(emvTransResult.getCard_no()));
//                            gaTranResponseInfo.setCardExpireDate(emvTransResult.getCardExpiryDate());
//                            gaTranResponseInfo.setCardHolderName(emvTransResult.getCardHolderName());
//                            gaTranResponseInfo.setAid(emvTransResult.getField4F());
//
//
//                            // showResult(textView, "" + EmvUtil.showEmvTransResult());
//                            String cdx = maskedPAN + "|" + emvTransResult.getCardHolderName() + "|" + emvTransResult.getCardExpiryDate() + "|" + emvTransResult.getCardTrack2() + "|"
//                                    + emvTransResult.getICCData() + "|" + emvTransResult.getCardSequence() + "|" + "00";
//                            tranInfo.setBillRefNo(cdx);
//
//                            Log.d("==>", "AID ==> emvTransResult.getField4F" + emvTransResult.getField4F());
//                            Log.d("==>", "AID ==>  gaTranResponseInfo.setAid" +  gaTranResponseInfo.getAid());
//                            Log.d("==>", "AID ==>  emvTransResult.getCardHolderName()" +  emvTransResult.getCardHolderName());
//
//
//                            gaTranResponseInfo.setAppLabel(emvTransResult.getApplabel());
//                            gaTranResponseInfo.setCardScheme(emvTransResult.getCardOrg());
//                            gaTranResponseInfo.setAmount(String.valueOf(emvTransResult.getAmount()));
//                            gaTranResponseInfo.setCurrency(emvTransResult.getCardIssuerCountryCode());
                        ...
                        if (formatID.equals("31") || formatID.equals("40") || formatID.equals("37") || formatID.equals("17") || formatID.equals("11") || formatID.equals("10")) {
                            ...
                            Log.d("==>", "content ==>  NFC" +  content.toString());
                            ...
                            content += "pinRandomNumber:" + " " + pinRandomNumber + "\n";
                            cardNo = maskedPAN;
                            Log.d("==>", "content ==>  NON-NFC" +  content.toString());
                        }
                        nfcData = content;
                        Log.d("==>", "content ==>  content-NFC" +  content.toString());
                        sendMsg(8003);
                    }
        ...
        public void onRequestOnlineProcess(final String tlv) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Log.d("==>", "content ==>  onRequestOnlineProcess" +  tlv.toString());
        ...
        public void onRequestTransactionResult(QPOSService.TransactionResult transactionResult) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Log.d("==>", "content ==>  onRequestTransactionResult" +  transactionResult.toString());
        ...
        public void onRequestBatchData(String tlv) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Log.d("==>", "content ==>  onRequestBatchData" +  tlv.toString());
